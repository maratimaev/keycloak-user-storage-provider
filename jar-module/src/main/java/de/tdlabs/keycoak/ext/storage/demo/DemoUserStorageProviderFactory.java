...
public class DemoUserStorageProviderFactory implements UserStorageProviderFactory<DemoUserStorageProvider> {
  ...
  private static final Logger logger = Logger.getLogger(DemoUserStorageProviderFactory.class);
  ...
  public void init(Config.Scope config) {
    ...
    logger.errorv("Configured {0} with someProperty: {1}", this, someProperty);
  }
